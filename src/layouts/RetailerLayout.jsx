...
export default function RetailerLayout({ children }) {
    ...
    const menuItems = [
        { icon: Home, label: 'Home', path: '/retailer/dashboard' },
        { icon: Clock, label: 'History', path: '/retailer/history' },
        { icon: Settings, label: 'Settings', path: '/retailer/settings' },
        { icon: HelpCircle, label: 'Help & support', path: '/retailer/help' },
    ];
        ...
        <div className="app-container" style={{ minHeight: '100vh', position: 'relative', backgroundColor: 'var(--white)' }}>
            ...
            >
                ...
                <div style={{ padding: '3rem 1.5rem 1.5rem', display: 'flex', alignItems: 'center', gap: '1rem' }}>
                    ...
                    <div>
                        <span style={{ fontWeight: '800', fontSize: '0.9rem', display: 'block' }}>Sarah Arinze</span>
                        <span style={{ fontSize: '0.7rem', color: 'var(--text-muted)' }}>saraharinze@gmail.com</span>
                    </div>
                </div>
